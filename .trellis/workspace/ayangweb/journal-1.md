...
Configured release-it with beta, RC, and stable release commands; added bumper-based Cargo version syncing; moved next-release notes to RELEASE-NEXT.md while leaving CHANGELOG.md generated by release-it; recorded the release versioning contract.
